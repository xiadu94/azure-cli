...
class ImportImageParameters(Model):
    ...
    :type source:
     ~azure.mgmt.containerregistry.v2018_09_01.models.ImportSource
    ...
    :param mode: When Force, any existing target tags will be overwritten.
     ...
     value: "NoForce" .
    :type mode: str or
     ~azure.mgmt.containerregistry.v2018_09_01.models.ImportMode
    """
    ...
    def __init__(self, source, target_tags=None, untagged_target_repositories=None, mode="NoForce"):
        super(ImportImageParameters, self).__init__()
        self.source = source
